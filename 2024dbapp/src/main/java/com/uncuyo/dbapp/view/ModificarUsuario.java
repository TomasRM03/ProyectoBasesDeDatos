...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Antes de colocar todos los datos ingrese el Cuil y presione el boton \"Buscar\"");
    ...
    private void BuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscarMouseClicked
        try {
            ...
            Usuario usuario = mainframe.getUsuario(cuil);
            txtAguaUsuario.setText(usuario.getAguapromedio().toString());
            txtApellidoUsuario.setText(usuario.getApellido());
            txtFechaUsuario.setText(usuario.getFechaNacimiento().toString());
            txtGeneroUsuario.setText(usuario.getGenero());
            txtHsDeporteUsuario.setText(usuario.getHorasDeporteSemanales().toString());
            txtNombreUsuario.setText(usuario.getNombre());
            txtSexoUsuario.setText(String.valueOf(usuario.getSexo()));
            txtSuenoUsuario.setText(usuario.getSuenopromedio().toString());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "No se ha encontrado el Cuil, reintente", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Usuario usuario = mainframe.getUsuario(cuil);
        mainframe.modificarDatosUsuario(cuil, nombre, apellido, sueno, agua, fechaNacimiento, sexo, genero, horasDeporte, usuario.getImc(), usuario.getEstadoPeso());
        this.dispose();
