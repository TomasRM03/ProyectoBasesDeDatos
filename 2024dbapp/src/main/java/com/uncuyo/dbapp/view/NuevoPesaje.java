 ...
 * @author tomas
 */
public class NuevoPesaje extends javax.swing.JFrame {

    /**
     * Creates new form NuevoPesaje
     */
    public NuevoPesaje() {
        initComponents();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        mainframe.insertarPesaje(cuil1, fecha1, peso1);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoPesaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoPesaje().setVisible(true);
            }
        });
    }
